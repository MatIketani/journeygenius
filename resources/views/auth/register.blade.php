            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ trans('main.name') }}</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('google.redirect') }}" class="btn btn-primary">{{ trans('main.register_with_google') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
